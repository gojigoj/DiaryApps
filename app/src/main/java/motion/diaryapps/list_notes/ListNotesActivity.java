...
public class ListNotesActivity extends AppCompatActivity {
    ...
    public void initDummy() {
        ...
        mLists.add(new ListNotesModel("1","@drawable/img_cover","20 APRIL 2019","Paradise Lost"));
        mLists.add(new ListNotesModel("2","@drawable/img_cover","20 APRIL 2019","Paradise Lost"));
        mLists.add(new ListNotesModel("3","@drawable/img_cover","20 APRIL 2019","Paradise Lost"));
